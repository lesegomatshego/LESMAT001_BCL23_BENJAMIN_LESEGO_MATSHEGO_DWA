...
class BookPreview extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // Update the component with the provided data
      const button = this.shadowRoot.querySelector('button.preview');
      const blurImage = this.shadowRoot.querySelector('.overlay__blur');
      const imageElement = this.shadowRoot.querySelector('.overlay__image');
